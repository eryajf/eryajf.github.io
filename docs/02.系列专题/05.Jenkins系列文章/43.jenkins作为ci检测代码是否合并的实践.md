...
![image-20210822162832429](https://tvax2.sinaimg.cn/large/008k1Yt0gy1gtpouo83rzj61cu0qoae102.jpg)
...
![image-20210822163504049](https://tvax3.sinaimg.cn/large/008k1Yt0gy1gtpov97elhj61jq0tm7dq02.jpg)
...
- `gitLabConnection`：要在系统管理中创建一个可操作gitlab的token，非常重要，如果没有此项配置，则流水线无法将状态回调给gitlab项目。
  ...
  ![image-20210822164215918](https://tvax1.sinaimg.cn/large/008k1Yt0gy1gtpovv2xnmj61q40k4wh902.jpg)
...
![image-20210822165603446](https://tvax1.sinaimg.cn/large/008k1Yt0gy1gtpow7td9wj61da0kmn0z02.jpg)

注意，此时merge按钮仍旧是绿色的，这是一个不足之处，只有当流水线开始触发，将状态置为pennding时才会转变，如果你知道有更好的办法控制这个按钮，欢迎留言交流。

接着就会自动触发流水线进行静态检测，如果成功，则会有如下显示：

![image-20210822165933221](https://tvax2.sinaimg.cn/large/008k1Yt0gy1gtpowqncodj61d40x2tee02.jpg)

此时需要进行merge的同学其实不必再纠结提交配置文件的语法是否有问题，只需要Review下Changes的内容即可决定是否merge。

如果失败，则状态如下：

![image-20210822171048655](https://tvax3.sinaimg.cn/large/008k1Yt0gy1gtpox6tln6j61d40vu44s02.jpg)
