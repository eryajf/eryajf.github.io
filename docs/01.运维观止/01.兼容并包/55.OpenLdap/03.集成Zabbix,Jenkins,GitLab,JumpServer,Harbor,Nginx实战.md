...
保存之后，就可以通过ldap当中，Jenkins组内的用户名密码进行登陆了，这里只是解决了用户能够登陆Jenkins的问题，具体Jenkins中详细的用户权限分配，可以参考[这篇文章进行配置](http://www.eryajf.net/1445.html)。
...
![image-20191029140020957](https://tvax1.sinaimg.cn/large/71cfeb93gy1g8l5fx8j1rj20tq0yuadi.jpg)
...
如果你当前使用的是openresty，那么可以[参考这篇文章进行模块的添加](http://www.eryajf.net/5019.html)。
